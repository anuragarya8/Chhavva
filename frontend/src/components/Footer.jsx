    ...
    <div>
        <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm">
            ...
            <div>
                ...
                <ul className='flex flex-col gap-1'>
                    <li  className='text-gray-600 hover:text-black cursor-pointer'>+91 9876543210</li>
                    <li className='text-gray-600 hover:text-black cursor-pointer'>support@chhavva.com</li>
                    <li className='text-gray-600 hover:text-black cursor-pointer'>123, Chhavva Street, City</li>
                </ul>
            </div>
        </div>
